...
\newcommand{\catA}{\catletter{A}}
\newcommand{\catB}{\catletter{B}}
...
\newcommand{\catalg}[1]{#1\text{-}\synalg}
...
%% for algebras
\newcommand{\synalg}{\syn{alg}}

%%%%
% Chapter 2-3 macros (contextual categories, M-L type theory)
%%%%

% Pullback S operator (note: \S is reserved for section symbol §)
\newcommand{\Sop}{\syn{S}}

% Contextual category structure
\newcommand{\synAtt}{\syn{Att}}      % Attributes
\newcommand{\synp}{\syn{p}}          % Projection map
\newcommand{\synq}{\syn{q}}          % Canonical section

% Type formers
\newcommand{\synPi}{\mathop{\Pi}\displaylimits}  % Pi type

% Reindexing maps
\newcommand{\syngamma}{\gamma}       % Canonical isomorphism γ
\newcommand{\synrho}{\rho}           % ρ map

% Base category
\newcommand{\synBase}{\syn{Base}}    % Base category functor
