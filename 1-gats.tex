...
The essentially algebraic theories of Freyd \cite{5:freyd} can be seen to have the same descriptive power as generalised algebraic theories, at least as far as the usual set valued models are concerned.
%
...
Essentially algebraic theories are introduced and very briefly discussed in Freyd \cite{5:freyd}; they are many sorted partial algebraic theories such that the domain of every partial operation is specified as the extension of some conjunction of identities between terms compounded from previously introduced operators.
...
This is the content of a remark made by Lawvere, pages 8--9 of Lawvere \cite{17:lawvere}, though the remark does not actually use the term essentially algebraic.
...
%
Compare with Lambek \cite{19:lambek}, though of course the problem is Gentzen's.
